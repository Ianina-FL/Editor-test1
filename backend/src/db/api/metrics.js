...
module.exports = class MetricsDBApi {
  static async create(data, options) {
    ...
    await metrics.setDepartment_manager(data.department_manager || null, {
      transaction,
    });

    await metrics.setOrganizations(data.organizations || null, {
      transaction,
    });
  ...
  static async update(id, data, options) {
    ...
    if (data.department_manager !== undefined) {
      await metrics.setDepartment_manager(
    ...
    if (data.organizations !== undefined) {
      await metrics.setOrganizations(
        data.organizations,
  ...
  static async findBy(where, options) {
    ...
    output.department_manager = await metrics.getDepartment_manager({
      transaction,
    });

    output.organizations = await metrics.getOrganizations({
      transaction,
    });
    ...
    let include = [
      {
        ...
        where: filter.department_manager
          ? {
              [Op.or]: [
                {
                  id: {
                    [Op.in]: filter.department_manager
                      .split('|')
                ...
                {
                  firstName: {
                    [Op.or]: filter.department_manager
                      .split('|')
