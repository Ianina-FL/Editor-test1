module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('notes', 'organizationsId', {
        transaction,
      });

      await queryInterface.removeColumn('metrics', 'organizationsId', {
        transaction,
      });

      await queryInterface.removeColumn('leads', 'organizationsId', {
        transaction,
      });

      await queryInterface.removeColumn('contacts', 'organizationsId', {
        transaction,
      });

      await queryInterface.removeColumn('activities', 'organizationsId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('metrics', 'department_managerId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('activities', 'activity_date', {
        transaction,
      });
