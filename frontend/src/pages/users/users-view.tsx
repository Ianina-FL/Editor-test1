    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Metrics DepartmentManager</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.metrics_department_manager &&
                      Array.isArray(users.metrics_department_manager) &&
                      users.metrics_department_manager.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
              ...
              {!users?.metrics_department_manager?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
